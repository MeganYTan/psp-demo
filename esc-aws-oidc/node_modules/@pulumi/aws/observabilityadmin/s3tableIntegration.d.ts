...
export declare class S3TableIntegration extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: S3TableIntegrationState, opts?: pulumi.CustomResourceOptions): S3TableIntegration;
    /**
     ...
     */
    readonly destinationTableBucketArn: pulumi.Output<string>;
    /**
     * Encryption configuration block. Documented below.
     */
    readonly encryption: pulumi.Output<outputs.observabilityadmin.S3TableIntegrationEncryption>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.observabilityadmin.S3TableIntegrationTimeouts | undefined>;
    /**
...
//# sourceMappingURL=s3tableIntegration.d.ts.map