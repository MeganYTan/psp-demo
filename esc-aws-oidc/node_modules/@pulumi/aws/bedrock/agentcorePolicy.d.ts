 ...
 * ```
 */
export declare class AgentcorePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentcorePolicyState, opts?: pulumi.CustomResourceOptions): AgentcorePolicy;
    /**
     * Returns true if the given object is an instance of AgentcorePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AgentcorePolicy;
    /**
     * Policy definition. See `definition` Block for details.
     */
    readonly definition: pulumi.Output<outputs.bedrock.AgentcorePolicyDefinition>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.bedrock.AgentcorePolicyTimeouts | undefined>;
    /**
     ...
     */
    readonly validationMode: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=agentcorePolicy.d.ts.map