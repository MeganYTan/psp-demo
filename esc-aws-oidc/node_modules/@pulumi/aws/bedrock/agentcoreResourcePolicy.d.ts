 ...
 * ```
 */
export declare class AgentcoreResourcePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentcoreResourcePolicyState, opts?: pulumi.CustomResourceOptions): AgentcoreResourcePolicy;
    /**
     * Returns true if the given object is an instance of AgentcoreResourcePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AgentcoreResourcePolicy;
    /**
...
//# sourceMappingURL=agentcoreResourcePolicy.d.ts.map