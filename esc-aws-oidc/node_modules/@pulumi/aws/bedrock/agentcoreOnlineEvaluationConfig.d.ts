 ...
 * ```
 */
export declare class AgentcoreOnlineEvaluationConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentcoreOnlineEvaluationConfigState, opts?: pulumi.CustomResourceOptions): AgentcoreOnlineEvaluationConfig;
    /**
     ...
     */
    static isInstance(obj: any): obj is AgentcoreOnlineEvaluationConfig;
    /**
     * Data source configuration specifying where to read agent traces. See `dataSourceConfig` Block below.
     */
    readonly dataSourceConfig: pulumi.Output<outputs.bedrock.AgentcoreOnlineEvaluationConfigDataSourceConfig>;
    /**
     ...
     */
    readonly enableOnCreate: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly evaluators: pulumi.Output<outputs.bedrock.AgentcoreOnlineEvaluationConfigEvaluator[]>;
    /**
     ...
     */
    readonly executionStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly outputConfigs: pulumi.Output<outputs.bedrock.AgentcoreOnlineEvaluationConfigOutputConfig[]>;
    /**
     ...
     */
    readonly rule: pulumi.Output<outputs.bedrock.AgentcoreOnlineEvaluationConfigRule>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.bedrock.AgentcoreOnlineEvaluationConfigTimeouts | undefined>;
    /**
...
//# sourceMappingURL=agentcoreOnlineEvaluationConfig.d.ts.map