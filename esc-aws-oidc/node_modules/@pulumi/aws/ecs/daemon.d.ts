...
export declare class Daemon extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DaemonState, opts?: pulumi.CustomResourceOptions): Daemon;
    /**
     ...
     */
    readonly capacityProviderArns: pulumi.Output<string[]>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ecs.DaemonTimeouts | undefined>;
    /**
