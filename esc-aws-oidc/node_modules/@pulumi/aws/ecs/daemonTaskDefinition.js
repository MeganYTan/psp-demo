...
exports.DaemonTaskDefinition = void 0;
...
class DaemonTaskDefinition extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new DaemonTaskDefinition(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:ecs/daemonTaskDefinition:DaemonTaskDefinition';
    /**
...
//# sourceMappingURL=daemonTaskDefinition.js.map