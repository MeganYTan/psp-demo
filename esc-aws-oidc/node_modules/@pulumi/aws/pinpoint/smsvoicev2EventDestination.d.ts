 ...
 * ```
 */
export declare class Smsvoicev2EventDestination extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Smsvoicev2EventDestinationState, opts?: pulumi.CustomResourceOptions): Smsvoicev2EventDestination;
    /**
     ...
     */
    static isInstance(obj: any): obj is Smsvoicev2EventDestination;
    /**
     ...
     */
    readonly cloudwatchLogsDestination: pulumi.Output<outputs.pinpoint.Smsvoicev2EventDestinationCloudwatchLogsDestination | undefined>;
    /**
     * ARN of the parent configuration set.
     */
    readonly configurationSetArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly kinesisFirehoseDestination: pulumi.Output<outputs.pinpoint.Smsvoicev2EventDestinationKinesisFirehoseDestination | undefined>;
    /**
     ...
     */
    readonly matchingEventTypes: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly snsDestination: pulumi.Output<outputs.pinpoint.Smsvoicev2EventDestinationSnsDestination | undefined>;
    /**
...
//# sourceMappingURL=smsvoicev2EventDestination.d.ts.map