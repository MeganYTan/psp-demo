 ...
 * ```
 */
export declare class LogS3TableIntegrationSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogS3TableIntegrationSourceState, opts?: pulumi.CustomResourceOptions): LogS3TableIntegrationSource;
    /**
     ...
     */
    static isInstance(obj: any): obj is LogS3TableIntegrationSource;
    /**
     * Data source to associate with the S3 Table Integration. See `dataSource` Block below.
     */
    readonly dataSource: pulumi.Output<outputs.cloudwatch.LogS3TableIntegrationSourceDataSource>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.cloudwatch.LogS3TableIntegrationSourceTimeouts | undefined>;
    /**
...
//# sourceMappingURL=logS3TableIntegrationSource.d.ts.map