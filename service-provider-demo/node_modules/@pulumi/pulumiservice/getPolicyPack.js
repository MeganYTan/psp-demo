...
exports.getPolicyPackOutput = exports.getPolicyPack = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("./utilities"));
/**
 * Get details about a specific version of a policy pack.
 */
function getPolicyPack(args, opts) {
 ...
 * Get details about a specific version of a policy pack.
 */
function getPolicyPackOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getPolicyPackOutput = getPolicyPackOutput;
//# sourceMappingURL=getPolicyPack.js.map